...
public class EjercicioLinea {
    ...
    public static int distance( ArrayList<Pair<Integer,Integer>> recoger, int inix , int iniy){
    ...
    public static void main(String[] args) throws IOException{
        ...
        for(int i=0;i<escenarios;i++){
            ...
            System.out.println("The shortest path has length: "+distance(vertices,Integer.parseInt(aux[0]),Integer.parseInt(aux[1])));
